...
<body class="row bg" style="width: 100%; height: 100%">
	...
	<!-- 导航条 头部 -->
	<nav class="navbar navbar-default"> <%@include
		file="common/top.jsp"%> </nav>
			...
			<div class="row">
				...
				<div class="col-md-2" style="minheight: 200px; margin-top: 20px">
					...
					<ul class="list-group menu">
						...
						<c:forEach items="${channels }" var="channel" varStatus="index">
							<li class="list-group-item" data="/channel?id=${channel.id}"><a></a>
								${channel.name}</li>
						</c:forEach>
					</ul>
				</div>
					...
					<div id="myCarousel" class="carousel slide">
						...
						<div class="carousel-inner" style="border-radius: 25px;">
							<div class="item active">
								<img src="/resource/images/1.jpg" class="img-circle"
									style="align: center; width: 800px; height: 400px;"
									alt="First slide">
							</div>
							<div class="item">
								<img src="/resource/images/2.jpg" class="img-rounded"
									style="border-radius: 24px; align: center; width: 800px; height: 400px;"
									alt="Second slide">
							</div>
							<div class="item">
								<img src="/resource/images/3.jpg" class="img-rounded"
									style="align: center; width: 800px; height: 400px;"
									alt="Third slide">
							</div>
							<div class="item">
								<img src="/resource/images/4.jpg" class="img-rounded"
									style="align: center; width: 800px; height: 400px;"
									alt="Four slide">
							</div>
							<div class="item">
								<img src="/resource/images/5.jpg" class="img-circle"
									style="align: center; width: 800px; height: 400px;"
									alt="Five slide">
							</div>
						</div>
					...
					<div>
						<c:forEach items="${hotList.list }" var="article">
							<div class=row style="padding-bottom: 1px">
								<hr width="88%"
									style="background-color: #D2691E; border: none; height: 1px">
								<div class="col-md-2" style="text-align: right">
									<img height="80px" width="80px" src="/pic/${article.picture}">
								</div>
								<div class="col-md-10">
									<a href="javascript:showArticle(${article.id })">${article.title }</a>
									<br>
									<br> 频道:<a>${article.channel.name }</a> &nbsp;&nbsp; 分类:<a>${article.category.name }</a>
									<br> <br> ${article.user.username }发布于
						...
						<div class="row" style="text-align: center">
							...
							<ul class="pagination">
								...
								<c:forEach
									begin="${hotList.pageNum-2 > 1 ? hotList.pageNum-2:1}"
									end="${hotList.pageNum+2 > hotList.pages ? hotList.pages:hotList.pageNum+2}"
									varStatus="index">
									<c:if test="${hotList.pageNum!=index.index}">
										<li><a href="/index?page=${index.index}&key=${key}">${index.index}</a></li>
									</c:if>
									<c:if test="${hotList.pageNum==index.index}">
										<li><a href="/index?page=${index.index}&key=${key}"><strong>
				...
				<div class="col-md-2" style="minheight: 200px">
					...
					<div class="panel panel-primary">
						...
						<div class="panel-body">
							<c:forEach items="${imgArticles}" var="article" varStatus="index">
								<a href="javascript:showArticle(${article.id})">${index.index+1}.
									${article.title}</a>
								<br />
							</c:forEach>
						</div>
					...
					<div class="panel panel-primary">
						...
						<div class="panel-body">
							1.<a href="#">本网站禁止发布不良信息</a> <br /> 2.<a href="#">今日下午20:00下红包雨</a>
						</div>
					</div>
					...
					<div class="panel panel-success">
						...
						<div class="panel-body">
							...
							${index.index+1} . <a
									href="javascript:showArticle(${article.id })">${article.title}</a>
								<br />
							</c:forEach>
						</div>
					</div>
	...
	<div class="container-fluid">
		...
		<div class="row" style="margin-top: 13px" align="center">
			<c:forEach items="${linkList}" var="link">
				<div class="col-md-1">
					<a href="${link.url}" class="fl"><span style="color: green">${link.name}</span></a>
				</div>
			</c:forEach>
		</div>
