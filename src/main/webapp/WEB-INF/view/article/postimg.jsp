	...
	<form id="form">
		<div class="input-group">
			<span class="input-group-addon">文章标题</span> <input type="text"
				name="title" class="form-control" placeholder="文章标题"
				aria-describedby="basic-addon2">
		</div>
		<div class="input-group">
			<span class="input-group-addon">频道</span> <select
		...
		<div id="imgdiv">
			<div class="input-group">
				<span class="input-group-addon">图片</span> <input type="file"
					class="form-control" name="file">
			</div>
			<div class="input-group">
				<span class="input-group-addon">图片描述</span> <input type="Text"
					class="form-control" name="desc">
			</div>
		</div>
		<div class="input-group">
			<input type="button" onclick="addImg()" value="添加图片"> <input
				type="button" onclick="publish()" value="发布">
